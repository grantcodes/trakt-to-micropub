  ...
  return new Promise((resolve, reject) => {
    ...
    inquirer.prompt(questions)
      .then((results) => {
        ...
        nconf.save();
        if (nconf.get('micropub:token') && nconf.get('micropub:micropubEndpoint') && nconf.get('micropub:tokenEndpoint')) {
          resolve();
        } else {
      ...
      .then((token) => {
        ...
        nconf.set('micropub:micropubEndpoint', micropub.options.micropubEndpoint);
